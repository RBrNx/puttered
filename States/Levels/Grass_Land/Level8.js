...
level8.prototype = {
    /**
     * Pre-loads data for use in level 8
     */
    preload: function(){
    ...
    create: function() {
        ...
        Hills = this.game.add.sprite(0,1100,"Hills1");
        Hills.scale.setTo(2.5,1);
        Hills2 = this.game.add.sprite(0,1100,"Hills");
        Hills2.scale.setTo(2.5,1);
        ...
        Ball = this.game.add.sprite(150, 1730, "Ball");
    ...
    update: function(){
        ...
        Hills.y = (this.game.camera.y * 0.4) + 450;
        Hills2.x = this.game.camera.x * 0.2 - 20;
        Hills2.y = (this.game.camera.y * 0.2) + 600;
    ...
    FinishSwing: function() {
        ...
        var VelocityX = ((Power * Math.cos((Arrow.angle -90) * Radian) * 10)) * 1.2;
        var VelocityY = ((Power * Math.sin((Arrow.angle -90) * Radian) * 10)) * 1.2;
