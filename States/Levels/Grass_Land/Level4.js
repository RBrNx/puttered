...
level4.prototype = {
    /**
     * Pre-loads data for use in level 4
     */
    preload: function(){
    ...
    /**
     * Creates objects for use in level 4
     */
    create: function() {
        Started = "false";
        Power = 0;
        ...
        Fairway.body.loadPolygon("Physics", "Level4-Hole");
    ...
    /**
     * Turns off the collisions in the game
     */
    ...
    /**
     * Turns on collision in the game
     */
