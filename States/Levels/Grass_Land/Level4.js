/**
 * Created by Conor on 21/04/2015.
 */
/**
...
level4.prototype = {
    preload: function(){
        ...
        this.game.load.image("Fairway", "Graphics/Level_Assets/Grass_Land/Level4/Level4.png");
        this.game.load.image("FairwayHole", "Graphics/Level_Assets/Grass_Land/Level4/Level4-Hole.png");
        ...
        this.game.load.image("BackgroundP", "Graphics/BackgrounRd/Background-Pause.png");
    ...
    create: function() {
        ...
        Player = this.game.add.sprite(2280, 890, "Shot");
        Player.animations.add("Swing");
        Player.anchor.setTo(0.5, 0.5);

        Ball = this.game.add.sprite(Player.x, 890, "Ball");
        Ball.anchor.setTo(0.5, 0.5);
        this.game.physics.p2.enable(Ball);
        Ball.body.clearShapes();
        Ball.body.loadPolygon("Physics", "Ball");

        Water = this.game.add.sprite(280, 630, "Water");
        Water.scale.setTo(0.5);
        Water.animations.add("Water");
        Water.animations.play("Water", 5, true);

        Sand = this.game.add.sprite(1450, 1000, "Sand");
        Sand.scale.setTo(0.3, 0.3);
        this.game.physics.p2.enable(Sand);
        Sand.body.static = true;

        FairwayHole = this.game.add.sprite(this.game.world.centerX, 550, "FairwayHole");
        this.game.physics.p2.enable(FairwayHole);
        FairwayHole.body.kinematic = true;
        FairwayHole.body.clearShapes();
        FairwayHole.body.loadPolygon("Physics", "Level4-Hole");

        Block = this.game.add.sprite(2056, 260, "Block");
        Block.scale.setTo(4);
