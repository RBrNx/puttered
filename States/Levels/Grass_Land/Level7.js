...
level7.prototype = {
    /**
     * Pre-loads data for use in level 7
     */
    preload: function(){
    ...
    /**
     * Creates objects for use in level 7
     */
    create: function() {
        Started = "false";
        Power = 0;
        ...
        Block = this.game.add.sprite(900, 925, "Block");
        Block.scale.setTo(5);
        this.game.physics.p2.enable(Block, true);
        Block.body.static = true;

        Ball = this.game.add.sprite(150, 815, "Ball");
        Ball.anchor.setTo(0.5, 0.5);
        this.game.physics.p2.enable(Ball);
        Ball.body.clearShapes();
        Ball.body.loadPolygon("Physics", "Ball");

        Fairway = this.game.add.sprite(this.game.world.centerX, 600, "Fairway");
    ...
    /**
     * Disables collision in the game
     */
