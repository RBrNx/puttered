...
level6.prototype = {
    ...
    create: function() {
        ...
        Ball = this.game.add.sprite(2390, 1000, "Ball");
    ...
    update: function(){
        ...
        Hills.x = this.game.camera.x * 0.4 - 300;
        Hills.y = (this.game.camera.y * 0.4) - 650;
        Hills2.x = this.game.camera.x * 0.2 - 300;
        Hills2.y = (this.game.camera.y * 0.2) - 750;
