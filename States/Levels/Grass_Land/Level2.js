...
level2.prototype = {
    /**
     * Pre-loads data for use in level 2
     */
    preload: function(){
    ...
    /**
     * Creates objects for use in level 2
     */
    create: function() {
        Started = "false";
        Power = 0;
        ...
        Block = this.game.add.sprite(2553, 670, "Block");
        Block.scale.setTo(5);
        this.game.physics.p2.enable(Block);
        Block.body.static = true;

        Ball = this.game.add.sprite(100, 235, "Ball");
        ...
        Fairway.body.loadPolygon("Physics", "Level2-Hole");
