...
level2_5.prototype = {
    ...
    preload: function(){
        ...
        this.game.load.image("Fairway", "Graphics/Level_Assets/Spaced_Out/Level5/Level2-5-Hole.png");
    ...
    create: function() {
        ...
        Fairway.body.loadPolygon("Physics", "Level2-5-Hole");
