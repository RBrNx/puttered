...
level2_8.prototype = {
    ...
    preload: function(){
        ...
        this.game.load.image("Fairway", "Graphics/Level_Assets/Spaced_Out/Level8/Level2-8.png");

        this.game.world.setBounds(0, 0, 1920, 2500);
    },

    /**
     * Creates objects for use in level 8
     */
    create: function() {
        Started = "false";
        Power = 0;
        ...
        Player = this.game.add.sprite(950, 2340, "Shot");
        Player.animations.add("Swing");
        Player.anchor.setTo(0.5, 0.5);

        Ball = this.game.add.sprite(Player.x, 2340, "Ball");
        ...
        Water.rotation = 90 * Radian;

        Water2 = this.game.add.sprite(1460, 2035, "Water");
        Water2.scale.setTo(6, 0.3);
        Water2.animations.add("Water");
        Water2.animations.play("Water", 5, true);
        Water2.rotation = 270 * Radian;

        Water3 = this.game.add.sprite(1210, 100, "Water");
        Water3.scale.setTo(0.6, 0.3);
        Water3.animations.add("Water");
        Water3.animations.play("Water", 5, true);
        Water3.rotation = 180 * Radian;

        Block = this.game.add.sprite(220, 260, "Block");
        ...
        Fairway.body.loadPolygon("Physics", "Level2-8-Hole");
