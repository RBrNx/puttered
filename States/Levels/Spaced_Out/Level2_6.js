...
level2_6.prototype = {
    ...
    preload: function(){
        ...
        this.game.load.image("Fairway", "Graphics/Level_Assets/Spaced_Out/Level6/Level2-6.png");
    ...
    create: function() {
        ...
        Ball = this.game.add.sprite(1280, 570, "Ball");
    ...
    update: function(){
        ...
        if (this.game.input.activePointer.isDown && Paused != true && Scoreboard != undefined) {
            if (Scoreboard.input.checkPointerOver(this.game.input.activePointer)){
                this.game.state.start("Level2-7");
                MusicControl.stop();
            }
        }
